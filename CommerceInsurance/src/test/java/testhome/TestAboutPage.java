...
//    public void Header2() throws InterruptedException { PageFactory.initElements(driver,AboutPage.class);sleepFor(2);setHeader2(); }
   @Test
    public void searchBoxInput() throws InterruptedException { PageFactory.initElements(driver,AboutPage.class);sleepFor(2);setSearch("Autoloan");sleepFor(2);navigateBack();
...
//        sleepFor(2);handleNewTab(driver).close();sleepFor(2);}
 //@Test
    public void Iframe() throws InterruptedException { PageFactory.initElements(driver,AboutPage.class);iframeHandle(selectIframe);sleepFor(2);}
