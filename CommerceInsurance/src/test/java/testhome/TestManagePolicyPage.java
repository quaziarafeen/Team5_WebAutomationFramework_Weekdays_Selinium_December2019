...
public class TestManagePolicyPage extends ManagePolicyPage {
@Test
    public void clickOnManagePolicy() throws InterruptedException { PageFactory.initElements(driver, ManagePolicyPage.class);sleepFor(2);mouseHoverCustomerServices();
    sleepFor(2);selectManage();sleepFor(2); }

@Test
    public void clickONSelectState() throws InterruptedException { clickOnManagePolicy(); }
@Test
    public void clickOnGo() throws InterruptedException { PageFactory.initElements(driver, ManagePolicyPage.class);sleepFor(2);scrollUpDown(4800);selectOnGo(); }
@Test
    public void mouseHoverInsurancePolicy() throws InterruptedException { PageFactory.initElements(driver, ManagePolicyPage.class);sleepFor(2);mouseHoverInsurance(); }
@Test
...
@Test
    public void mouseHoverClaims() throws InterruptedException { PageFactory.initElements(driver, ManagePolicyPage.class);sleepFor(2);mouseHoverClaim();}
@Test
